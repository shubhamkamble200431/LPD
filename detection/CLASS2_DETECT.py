...
def tflite_detect_images(modelpath,lblpath,imgpath,min_conf,savepath=os.path.join('SaveImg','2CLASS','cpu4'),txt_only='False'):
...
#         # Get filenames and paths
        ...
        with open(os.path.join(savepath,'S2class.csv'),'a') as file:
...
savepath=os.path.join('SaveImg','2CLASS','cpu4')
PATH_TO_IMAGES=os.path.join('scripts','extra','FINAL_TEST')
PATH_TO_MODEL=os.path.join('tflite','2CLASS_final_16.tflite')
PATH_TO_LABEL=os.path.join('tflite2.txt')
