...
def tflite_detect_images(modelpath,lblpath,imgpath,min_conf,savepath=os.path.join('SaveImg','CAR','cpu3'),txt_only='False'):
...
#         # Get filenames and paths
        ...
        with open(os.path.join(savepath,'SCar.csv'),'a') as file:
...
savepath=os.path.join('SaveImg','CAR','cpu3')
PATH_TO_IMAGES=os.path.join('scripts','extra','FINAL_TEST')
PATH_TO_MODEL=os.path.join('tflite','Car_final_16.tflite')
PATH_TO_LABEL=os.path.join('tfliteC.txt')
