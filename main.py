...
GT_PATH = os.path.join(os.getcwd(),'scripts','extra','input')
DR_PATH = os.path.join(os.getcwd(),'SaveImg','LICENCE','cpu2')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(),'scripts','extra','FINAL_TEST')
